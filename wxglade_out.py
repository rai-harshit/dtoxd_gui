...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.9.3 on Fri May 17 21:07:59 2019
#
...
class root_frame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.spin_ctrl_1 = wx.SpinCtrl(self, wx.ID_ANY, "1", min=0, max=11, style=wx.SP_WRAP)
    ...
    def __do_layout(self):
        ...
        static_line_1.SetMinSize((2, 400))
        grid_sizer_1.Add(static_line_1, 0, wx.LEFT, 30)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
...
class MyDialog(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        label_2 = wx.StaticText(self, wx.ID_ANY, "This is a section which informs the user about the current version of the product, about the license details and any other important links and notes.", style=wx.ALIGN_CENTER)
        label_2.SetMinSize((400, 150))
        sizer_2.Add(label_2, 0, wx.ALL, 10)
