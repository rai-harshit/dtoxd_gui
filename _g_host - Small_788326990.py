...
# -*- coding: CP1252 -*-
#
# generated by wxGlade 0.9.3 on Wed May 29 14:29:33 2019
#
...
class _931769938_root_frame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
        label_13 = wx.StaticText(self, -1, "")
        grid_sizer_1.Add(label_13, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT, 20)
        grid_sizer_1.Add((0, 0), 0, 0, 0)
...
class MyApp(wx.App):
    def OnInit(self):
        self.frame = _931769938_root_frame(None, wx.ID_ANY, "")
